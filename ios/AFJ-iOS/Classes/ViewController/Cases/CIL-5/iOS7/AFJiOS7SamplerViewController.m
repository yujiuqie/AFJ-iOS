...
- (void)viewDidLoad {
    ...
    for (NSDictionary *obj in array) {
        ...
        item.cName = obj[kItemKeyTitle];
        item.cType = obj[kItemKeyClassPrefix];
...
- (void)cellAction:(id)data {
    ...
    NSString *className = [item.cType stringByAppendingString:@"ViewController"];
    ...
    if (NSClassFromString(className)) {
        ...
        if ([instance isKindOfClass:[UIViewController class]]) {
            ...
            [(UIViewController *)instance setTitle:item.cName];
