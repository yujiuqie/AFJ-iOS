...
- (void)setGoodsModel:(RecommendProduct *)goodsModel {
    ...
    if (_isDiancang) {//如果电子仓库商品添加  电仓 图标
        ...
        goodsNameAttributeStr.color = [UIColor lightGrayColor];
        goodsNameAttributeStr.lineSpacing = 5;
    ...
    if (goodsModel.store_id == 72) {// 天元
        ...
        if (goodsModel.goods_id == 1297) {
            ...
            priceAttributeStr.font = [UIFont systemFontOfSize:14];
            priceAttributeStr.color = [UIColor lightGrayColor];
