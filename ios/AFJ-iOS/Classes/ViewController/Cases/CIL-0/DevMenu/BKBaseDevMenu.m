...
- (void)addSandBoxViewer:(NSArray<NSUserDefaults *> *)additionalUserDefaults {
    ...
    [self addTestPageWithTitle:@"沙盒1" andAction:^(UINavigationController *_Nonnull nav) {
    ...
    [self addTestPageWithTitle:@"沙盒2" andAction:^(UINavigationController *_Nonnull nav) {
    ...
    [self addTestPageWithTitle:@"沙盒3" andAction:^(UINavigationController *_Nonnull nav) {
...
- (void)addAppConsole {
    ...
    [self addTestPageWithTitle:@"日志" andAction:^(UINavigationController *_Nonnull nav) {
