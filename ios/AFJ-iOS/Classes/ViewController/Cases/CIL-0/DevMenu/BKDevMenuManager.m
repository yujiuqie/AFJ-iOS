        ...
        if (window != self.devWindow) {
            if (window.rootViewController) {
                if ([window.rootViewController isKindOfClass:[UITabBarController class]]) {
                    ...
                    break;
                } else if ([window.rootViewController isKindOfClass:[MMDrawerController class]]) {
                    targetNav = (UINavigationController *) ((MMDrawerController *) window.rootViewController).centerViewController;
                    break;
                }
            }
