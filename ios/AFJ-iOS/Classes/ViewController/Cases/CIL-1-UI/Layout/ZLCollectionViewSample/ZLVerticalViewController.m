...
@implementation ZLVerticalViewController
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 8) {
        ZLMultilineTextCell *cell = [ZLMultilineTextCell cellWithCollectionView:collectionView forIndexPath:indexPath];
...
//                    return CGSizeMake((collectionView.frame.size.width-20-150)/2, 100);
        ...
        case 8: {
            ...
            return [collectionView ar_sizeForCellWithIdentifier:@"ZLMultilineTextCell"
                                                      indexPath:indexPath
                                                     fixedWidth:fixedWidth
                                                  configuration:^(__kindof ZLMultilineTextCell *cell) {
                                                      cell.label.text = self.arrayTexts[indexPath.row];
                                                  }];
        }
        case 9: {
...
- (UICollectionView *)collectionViewLabel {
    if (!_collectionViewLabel) {
        ...
        [_collectionViewLabel registerClass:[ZLMultilineTextCell class] forCellWithReuseIdentifier:[ZLMultilineTextCell cellIdentifier]];
