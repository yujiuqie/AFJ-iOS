...
@implementation ZLHorzontalViewController
...
- (UICollectionView *)collectionViewLabel{
    if(!_collectionViewLabel){
        _collectionViewLabel = ({
            ...
            [object registerClass:[ZLMultilineTextCell class] forCellWithReuseIdentifier:@"ZLMultilineTextCell"];
