...
- (void)viewDidLayoutSubviews {
    ...
    CGFloat inset = 12;
    self.textCountLabel.frame = CGRectMake(inset, self.qmui_navigationBarMaxYInViewCoordinator + 20, CGRectGetWidth(self.view.bounds) - 2 * inset, QMUIViewSelfSizingHeight);
