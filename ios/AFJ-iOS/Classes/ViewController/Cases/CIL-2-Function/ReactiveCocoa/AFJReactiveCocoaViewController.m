...
- (void)viewDidLoad {
    ...
    }
    {
        __weak typeof(self) weakSelf = self;
        AFJCaseItemData *item = [AFJCaseItemData new];
        item.cName = @"RACDisposable 取消订阅示例";
        item.didSelectAction = ^(id data) {
    ...
    }
    {
        __weak typeof(self) weakSelf = self;
        AFJCaseItemData *item = [AFJCaseItemData new];
        item.cName = @"RACSubject (信号与订阅)简单示例";
        item.didSelectAction = ^(id data) {
    ...
    }
    {
        __weak typeof(self) weakSelf = self;
        AFJCaseItemData *item = [AFJCaseItemData new];
        item.cName = @"RACReplaySubject 先发信号再订阅示例";
        item.didSelectAction = ^(id data) {
    ...
    }
    {
        __weak typeof(self) weakSelf = self;
        AFJCaseItemData *item = [AFJCaseItemData new];
        item.cName = @"RACMulticastConnection 示例";
        item.didSelectAction = ^(id data) {
    ...
    }
    {
        __weak typeof(self) weakSelf = self;
        AFJCaseItemData *item = [AFJCaseItemData new];
        item.cName = @"rac_liftSelector 多请求处理示例";
        item.didSelectAction = ^(id data) {
