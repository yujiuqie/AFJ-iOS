//
//  AFJBTPeripheralModeViewController.m
//  AFJ-iOS
//
...
@interface AFJBTPeripheralModeViewController () {
    BabyBluetooth *baby;
}

@end

@implementation AFJBTPeripheralModeViewController
...
- (void)viewDidLoad {
    ...
    makeCharacteristicToService(s1, @"FFF4", nil, @"hello499");//默认读写字段
