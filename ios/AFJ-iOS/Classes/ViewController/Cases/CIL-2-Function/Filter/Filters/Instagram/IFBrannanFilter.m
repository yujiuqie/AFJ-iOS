...
- (id)init {
    self = [super initWithFragmentShaderFromString:kIFBrannanShaderString
                                           sources:@[
                                                   [IFImageFilter filterImageNamed:@"brannanProcess"],
                                                   [IFImageFilter filterImageNamed:@"brannanBlowout"],
                                                   [IFImageFilter filterImageNamed:@"brannanContrast"],
                                                   [IFImageFilter filterImageNamed:@"brannanLuma"],
                                                   [IFImageFilter filterImageNamed:@"brannanScreen"],
                                           ]];
    return self;
}
@end
