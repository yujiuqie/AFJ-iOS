...
- (id)init {
    self = [super initWithFragmentShaderFromString:kIFHudsonShaderString
                                           sources:@[
                                                   [IFImageFilter filterImageNamed:@"hudsonBackground"],
                                                   [IFImageFilter filterImageNamed:@"overlayMap"],
                                                   [IFImageFilter filterImageNamed:@"hudsonMap"],
                                           ]];
    return self;
}
