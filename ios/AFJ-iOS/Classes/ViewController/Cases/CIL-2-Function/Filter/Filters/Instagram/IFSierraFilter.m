...
- (id)init {
    self = [super initWithFragmentShaderFromString:kIFSierraShaderString
                                           sources:@[
                                                   [IFImageFilter filterImageNamed:@"sierraVignette"],
                                                   [IFImageFilter filterImageNamed:@"overlayMap"],
                                                   [IFImageFilter filterImageNamed:@"sierraMap"],
                                           ]];
    return self;
}
