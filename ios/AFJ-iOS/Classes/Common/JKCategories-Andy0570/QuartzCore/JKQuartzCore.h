...
#if __has_include(<JKCategories/JKQuartzCore.h>)
#import <JKCategories/CAAnimation+JKEasingEquations.h>
#import <JKCategories/CALayer+JKBorderColor.h>
#import <JKCategories/CAMediaTimingFunction+JKAdditionalEquations.h>
